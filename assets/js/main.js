        ...
        <div class = "modal"> 
          ...
          <div class="flex modal-content">
            ...
            <div class="">
              <p class="ff-inter">${element.content}</p>
              <div class = " buttons mg-2 flex">
                <a class="btn flex btn-modal" href='${element.liveLink}' target="_blank">See Live <img src="./assets/img/see-live-icon.png" alt="see-live-icon"> </a>
                <a class="btn flex btn-modal" href='${element.source}' target="_blank">See Source <img src="./assets/img/github.png" alt="github"> </a>
              </div>
            </div>
          </div>
      </div>
